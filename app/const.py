...
pun_exec = '#ผัน'
puan_how_to =\
    f"""ยอดนักผวนใช้ได้กับตัวอักษรภาษาไทยเท่านั้นและ ตอบเฉพาะคนที่แอดเป็นเพื่อนกันนะ กดที่ profile แล้วเพิ่มเพื่อน ได้เลย
...
pun_how_to =\
    f"""ยอดนักผันใช้ได้กับตัวอักษรภาษาไทยเท่านั้นและตอบเฉพาะคนที่แอดเป็นเพื่อนกันนะ กดที่ profile แล้วเพิ่มเพื่อน ได้เลย
การใช้งานให้พิมตามคำสั่งด้านล่างต่อไปนี้

{pun_exec}
-ใช้เพื่อผันข้อความล่าสุดทุกคำ
...
#ออกไปเลยชิ่วๆ 
- เบื่อแล้วไล่ออกยอดนักผันไปจากห้อง"""

lu_how_to =\
    f"""ยอดนักลู แปลงภาษาไทยเป็นภาษาลูไปกลับได้,ใช้ได้กับตัวอักษรภาษาไทยเท่านั้น ตอบเฉพาะคนที่แอดเป็นเพื่อนกันนะ กดที่ profile แล้วเพิ่มเพื่อน ได้เลย
การใช้งานให้พิมตามคำสั่งด้านล่างต่อไปนี้
...
#ออกไปเลยชิ่วๆ 
- เบื่อแล้วไล่ออกยอดนักลูไปจากห้อง"""

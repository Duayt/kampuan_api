...
PUN_CONST = {'action': 'ผัน',
             'greeting': 'สวัสดี ดี่ ดี้ ดี๊ ดี ยอดนักผัน มาแลว แหล่ว แล่ว แล้ว แหลว อยากรู้จักยอดนักผวนมากขึ้นพิมพ์ #ยอดนักผัน"""',
...
LU_CONST = {'action': 'ลู',
            'greeting': 'หละสุหลัสหวูสลีดู ลอดยูดลักนูกซูลี ลามูแซ้วลู้ว อยากรู้จักยอดนักผวนมากขึ้นพิมพ์ #ยอดนักลู"""',
